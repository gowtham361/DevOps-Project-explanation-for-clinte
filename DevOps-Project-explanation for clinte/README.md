# 🚀 **DevOps Project: Hospital App Deployment**

In this **DevOps project**, I demonstrate how to **deploy a Hospital App** using a variety of modern DevOps tools and services.
